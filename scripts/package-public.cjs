...
const files=[
 ...
 'dist/source-layouts.js','dist/setup.js','dist/experiments.js','dist/experiment-coordinator.js','dist/runner.js','dist/experiments-ui.js','dist/experiments.css','dist/research-workbench.css',
 'tests/fixtures/filter-setup.cjs','tests/test-setup.cjs','tests/test-experiments.cjs','tests/test-experiments-ui.cjs','tests/test-research-workbench.cjs','tests/test-runner.cjs','tests/test-choice-cache.cjs','docs/EXPERIMENTS.md','docs/images/10-experiments.png','docs/images/11-test-setup.png','docs/images/12-date-range.png','docs/images/13-study-progress.png',
