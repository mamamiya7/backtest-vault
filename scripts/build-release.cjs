...
const runtimeFiles=['background.js','capture.js','core.js','dashboard.js','demo.js','experiment-coordinator.js','experiments-ui.js','experiments.css','experiments.js','index.html','intelligence-ui.js','intelligence.js','manifest.json','presentation.js','runner.js','setup.js','source-layouts.js','storage.js','vault.css'];
