...
| A dropdown is missing a recently added rule | Use **Refresh choices**, then choose the intended category. Radar and Strategy 1–3 load every category offered by their source rows. Empty account categories stay empty; unavailable old selections need review. |
