...
- Experiments includes a Candle DOM runner, finite/sample/adaptive planner and durable journal. New test in v0.8.6 preview configures a complete Candle/Price setup in Vault and refreshes available rule menus from RZone. Live acceptance of this new flow remains pending. The v0.7.3 three-trial period sweep covered one fixed saved baseline. P&F/Renko execution, dynamic RS and Market Trend Filter remain gated. See [Experiments](EXPERIMENTS.md).
