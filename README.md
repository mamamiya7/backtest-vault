...
**v0.18.5 preview** · Chrome · Local storage · MIT · No cloud account
...
**[Download the complete release ZIP](https://github.com/mamamiya7/backtest-vault/releases/latest)**. Use the versioned **backtest-vault-*.zip** asset; do not download a setup script by itself. The latest published download can be older than the preview source while live acceptance is pending.
