...
**v0.17.1 preview** · Chrome · Local storage · MIT · No cloud account
...
**[Download the complete release ZIP](https://github.com/mamamiya7/backtest-vault/releases/latest)**. Use the named **backtest-vault-0.17.1.zip** asset; do not download a setup script by itself.
